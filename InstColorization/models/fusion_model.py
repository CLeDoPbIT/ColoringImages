...
from InstColorization.util.image_pool import ImagePool
...
class FusionModel(BaseModel):
    ...
    def setup_to_test(self, fusion_weight_path):
        GF_path = 'InstColorization/checkpoints/{0}/latest_net_GF.pth'.format(fusion_weight_path)
        ...
        G_path = 'InstColorization/checkpoints/{0}/latest_net_G.pth'.format(fusion_weight_path)
        ...
        GComp_path = 'InstColorization/checkpoints/{0}/latest_net_GComp.pth'.format(fusion_weight_path)
